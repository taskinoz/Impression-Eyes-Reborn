...
SectionGroup /e "File associations (optional)" AssociationsGroup
  ...
  !insertmacro AssociationSection AssocJpegXl "JPEG XL images (.jxl)" "ime-reborn.jxl" "JPEG XL image" "image/jxl"
...
Section -FinalizeAssociations
  ...
  !insertmacro RegisterExtension ${AssocJpegXl} "jxl" "ime-reborn.jxl" "image/jxl"
...
Section "Uninstall"
  ...
  !insertmacro UnregisterExtension "jxl" "ime-reborn.jxl"
  ...
  DeleteRegKey HKCU "Software\Classes\ime-reborn.jxl"
